      ...
      .then((result) => {
        if (result.success == true) {
          ...
          setData([
            ...
            //review coverage, read live from the extended /dashboard response
            ...(isReviewsEnabled()
              ? [
                  {
                    id: 5,
        ...
        <View style={{ flex: 1, width: "100%" }}>
          <ScrollView testID="dashboard-actions-scroll" style={styles.actionContainer}>
            ...
            <OptionList
              ...
              type="morden"
            />
            {/* Turning the client flag off hides every review surface, the
                moderation entry point included. */}
            {isReviewsEnabled() && (
              <OptionList
