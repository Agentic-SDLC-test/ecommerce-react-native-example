    ...
    <View style={styles.container} testID="my-order-detail-screen">
      ...
      >
        ...
        <View style={styles.orderInfoContainer}>
          ...
          <Text style={styles.secondarytextMedian} testID="my-order-detail-fulfilment-heading">
            Fulfilment
          </Text>
        ...
        <View style={styles.orderInfoContainer}>
          ...
          <Text style={styles.secondarytextSm} testID="my-order-detail-payment-message">
            {paymentConfirmationText(orderDetail)}
          </Text>
          {paymentUpdatedAt(orderDetail) && (
            <Text style={styles.secondarytextSm} testID="my-order-detail-payment-updated">
