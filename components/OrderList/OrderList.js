  ...
  return (
    <View style={styles.container} testID={testID}>
      ...
      <View style={styles.paymentRow}>
        ...
        <View
          style={[styles.paymentBadge, styles[`paymentBadge_${getPaymentStatusTone(item?.payment_status)}`]]}
          testID={testID ? `${testID}-payment-status-badge` : undefined}
        >
          <Text
...
const styles = StyleSheet.create({
  ...
  paymentBadge_warning: {
    backgroundColor: colors.warning,
  },
  paymentBadge_success: {
